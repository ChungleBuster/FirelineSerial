/**
 * Parallel Fork/Join driver for the Fireline parallel-programming assignment.
 *
 * This mirrors {@link FirelineSerial} exactly in command-line interface,
 * console output and image output, but performs each simulation timestep
 * using the Fork/Join based {@link FireMapParallel#stepParallel} instead of
 * the serial {@link FireMap#step}.
 *
 * Usage:
